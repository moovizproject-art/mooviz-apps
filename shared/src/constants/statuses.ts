...
export const STATUS_TRANSITIONS: Record<DeliveryStatus, DeliveryStatus[]> = {
  ...
  pending: ["awaiting_confirm", "waiting_for_pickup", "new", "cancelled"],
  awaiting_confirm: ["waiting_for_pickup", "pending", "new", "cancelled"],
...
export const TRANSITION_ACTORS: Record<string, Array<UserRole | "system">> = {
  ...
  "awaiting_confirm -> new": ["sender", "driver", "system"],
 ...
 */
export const SCHEDULED_TIMEOUT_HOURS_AFTER_DATE = 24;

/** @deprecated Use ASAP_TIMEOUT_HOURS or SCHEDULED_TIMEOUT_HOURS_AFTER_DATE */
