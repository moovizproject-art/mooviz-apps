...
export const strings = {
  ...
  common: {
    ...
    change: { he: 'שנה', en: 'Change' } as LocaleStrings,
    tryAgain: { he: 'נסה שוב', en: 'Try again' } as LocaleStrings,
    ok: { he: 'אישור', en: 'OK' } as LocaleStrings,
    offline: { he: 'אין חיבור לאינטרנט', en: 'No internet connection' } as LocaleStrings,
    reloginRequired: { he: 'נדרשת התחברות מחדש. אנא צא והתחבר שוב.', en: 'Re-login required. Please sign out and sign in again.' } as LocaleStrings,
  ...
  home: {
    ...
    tapNewDelivery: {
      he: 'לחצו על \'התחל משלוח\' כדי ליצור משלוח חדש',
      en: "Tap 'Start delivery' to create a new delivery",
    } as LocaleStrings,
    ...
    notificationsOn: { he: 'התראות מופעלות', en: 'Notifications On' } as LocaleStrings,
    notificationsOff: { he: 'התראות מושבתות', en: 'Notifications Off' } as LocaleStrings,
    ...
    deleteAccount: { he: 'מחק חשבון', en: 'Delete Account' } as LocaleStrings,
    deleteAccountConfirmTitle: { he: 'מחיקת חשבון', en: 'Delete Account' } as LocaleStrings,
    deleteAccountConfirmMessage: {
      he: 'פעולה זו בלתי הפיכה. כל הנתונים שלך יימחקו לצמיתות. האם אתה בטוח?',
      en: 'This action is irreversible. All your data will be permanently deleted. Are you sure?',
    } as LocaleStrings,
    deleteAccountError: { he: 'שגיאה במחיקת החשבון. נסה שוב.', en: 'Error deleting account. Please try again.' } as LocaleStrings,
  },
  ...
  form: {
    ...
    dragPinHint: { he: 'לחץ על המפה לבחירת המיקום המדויק', en: 'Tap on the map to select the exact location' } as LocaleStrings,
    ...
    asapHint: { he: 'כבה את המתג כדי לתזמן לתאריך עתידי', en: 'Turn off the toggle to schedule for a future date' } as LocaleStrings,
    scheduledHint: { he: 'הפעל את המתג כדי לחזור לאיסוף בהקדם', en: 'Turn on the toggle to switch back to ASAP' } as LocaleStrings,
    ...
    helpTitle: { he: 'הסבר — יצירת משלוח', en: 'Guide — Create a delivery' } as LocaleStrings,
    validationError: { he: 'שדה חסר', en: 'Missing field' } as LocaleStrings,
    deliveryCreated: { he: 'משלוח נוצר', en: 'Delivery created' } as LocaleStrings,
    deliveryError: { he: 'שגיאה ביצירת משלוח', en: 'Delivery creation error' } as LocaleStrings,
    helpBody: {
    ...
    sizeGuide: { he: 'הסבר — מדריך מידות', en: 'Guide — Size guide' } as LocaleStrings,
  ...
  auth: {
    ...
    phoneTakenByOther: { he: 'מספר הטלפון הזה רשום לחשבון אחר. אנא השתמש במספר שלך.', en: 'This phone number is registered to another account. Please use your own number.' } as LocaleStrings,
    ...
    emailSpamHint: { he: 'לא קיבלת אימייל? בדוק גם בתיקיית הספאם/דואר זבל.', en: "Didn't receive the email? Check your spam or junk folder." } as LocaleStrings,
    phoneAlreadyRegistered: { he: 'מספר הטלפון כבר רשום במערכת. אנא התחבר עם חשבונך הקיים.', en: 'This phone number is already registered. Please log in with your existing account.' } as LocaleStrings,
  ...
  delivery: {
    ...
    // Size labels for DeliveryCard
    sizeSmall: { he: 'מעטפה', en: 'Envelope' } as LocaleStrings,
    sizeMedium: { he: 'חבילה', en: 'Package' } as LocaleStrings,
    sizeLarge: { he: 'חבילה גדולה', en: 'Large package' } as LocaleStrings,
    sizeXLarge: { he: 'משטח/ארגז', en: 'Pallet/Crate' } as LocaleStrings,
    // Time range labels
    timeRangeMorning: { he: 'בוקר 08–12', en: 'Morning 08–12' } as LocaleStrings,
    timeRangeAfternoon: { he: 'צהריים 12–16', en: 'Afternoon 12–16' } as LocaleStrings,
    timeRangeEvening: { he: 'ערב 16–20', en: 'Evening 16–20' } as LocaleStrings,
    timeRangeNight: { he: 'לילה 20–24', en: 'Night 20–24' } as LocaleStrings,
    waitingForResponse: { he: 'ממתין לתשובה', en: 'Waiting for response' } as LocaleStrings,
    label: { he: 'משלוח', en: 'Delivery' } as LocaleStrings,
    // Timeline step labels
    timelineNew: { he: 'חדש ✨', en: 'New ✨' } as LocaleStrings,
    timelinePending: { he: 'ממתין לנהג', en: 'Waiting for driver' } as LocaleStrings,
    timelineWaiting: { he: 'ממתין לאיסוף', en: 'Waiting for pickup' } as LocaleStrings,
    timelinePickedUp: { he: 'נאסף', en: 'Picked up' } as LocaleStrings,
    timelineDelivered: { he: 'נמסר', en: 'Delivered' } as LocaleStrings,
    ...
    // Payment section
    paymentWaiting: { he: 'ממתין לתשלום', en: 'Awaiting payment' } as LocaleStrings,
    senderConfirmedPayment: { he: 'אישרת תשלום — ממתין לאישור הנהג', en: 'You confirmed payment — waiting for driver confirmation' } as LocaleStrings,
    driverConfirmedPayment: { he: 'הנהג אישר קבלת תשלום — תורך לאשר', en: 'Driver confirmed payment — your turn to confirm' } as LocaleStrings,
    driverConfirmedPaymentDriver: { he: 'אישרת תשלום — ממתין לאישור השולח', en: 'You confirmed payment — waiting for sender confirmation' } as LocaleStrings,
    paymentScreenshot: { he: 'צילום מסך תשלום', en: 'Payment screenshot' } as LocaleStrings,
    chooseImageSource: { he: 'בחר מקור תמונה', en: 'Choose image source' } as LocaleStrings,
    fromGallery: { he: 'בחר מהגלריה', en: 'Choose from gallery' } as LocaleStrings,
    cameraPermissionRequired: { he: 'נדרשת גישה למצלמה לצילום אישור תשלום', en: 'Camera access required for payment confirmation photo' } as LocaleStrings,
    payBit: { he: 'שלם ב-Bit', en: 'Pay with Bit' } as LocaleStrings,
    payPaybox: { he: 'שלם ב-PayBox', en: 'Pay with PayBox' } as LocaleStrings,
    // Ratings section
    ratingsSection: { he: 'דירוגים', en: 'Ratings' } as LocaleStrings,
    yourRatingOnSender: { he: 'הדירוג שלך על השולח', en: 'Your rating of the sender' } as LocaleStrings,
    senderRatingOnYou: { he: 'דירוג השולח עליך', en: "Sender's rating of you" } as LocaleStrings,
    yourRatingOnDriver: { he: 'דירוג שלך על הנהג', en: 'Your rating of the driver' } as LocaleStrings,
    driverRatingOnYou: { he: 'דירוג הנהג עליך', en: "Driver's rating of you" } as LocaleStrings,
    confirmPickupDisabled: { he: 'אישור איסוף ✓', en: 'Confirm pickup ✓' } as LocaleStrings,
    cancelDelivery: { he: 'ביטול משלוח', en: 'Cancel delivery' } as LocaleStrings,
    confirmPayment: { he: 'אשר קבלת תשלום', en: 'Confirm payment received' } as LocaleStrings,
    // Alert messages
    assignedSuccess: { he: 'המשלוח שויך אליך', en: 'Delivery assigned to you' } as LocaleStrings,
    declinedSuccess: { he: 'דחית — המשלוח הוחזר לשולח', en: 'Declined — delivery returned to sender' } as LocaleStrings,
    cancelConfirmQuestion: { he: 'האם אתה בטוח שברצונך לבטל את האיסוף?', en: 'Are you sure you want to cancel the pickup?' } as LocaleStrings,
    cancelSuccess: { he: 'המשלוח בוטל בהצלחה', en: 'Delivery cancelled successfully' } as LocaleStrings,
    cancelError: { he: 'שגיאה בביטול המשלוח', en: 'Error cancelling delivery' } as LocaleStrings,
    driverSelectedMessage: { he: 'הנהג נבחר, ממתין לאישור', en: 'Driver selected, awaiting confirmation' } as LocaleStrings,
    chatCreationError: { he: 'שגיאה ביצירת צ׳אט', en: 'Error creating chat' } as LocaleStrings,
    chatNotAvailable: { he: 'הצ׳אט יהיה זמין לאחר אישור הנהג', en: 'Chat will be available after driver confirms' } as LocaleStrings,
    invalidPickup: { he: 'יש לבחור כתובת איסוף תקינה מהמפה', en: 'Please select a valid pickup address from the map' } as LocaleStrings,
    invalidDestination: { he: 'יש לבחור כתובת יעד תקינה מהמפה', en: 'Please select a valid destination address from the map' } as LocaleStrings,
  },
  ...
  profile: {
    ...
    kmAway: { he: 'ק״מ ממך', en: 'km away' } as LocaleStrings,
    recentReviews: { he: 'ביקורות אחרונות', en: 'Recent reviews' } as LocaleStrings,
    noReviews: { he: 'אין ביקורות עדיין', en: 'No reviews yet' } as LocaleStrings,
    noComment: { he: 'ללא תגובה', en: 'No comment' } as LocaleStrings,
    showAllReviews: { he: 'הצג את כל {count} הביקורות', en: 'Show all {count} reviews' } as LocaleStrings,
    awaitingOtherDriver: { he: 'ממתין לאישור נהג אחר...', en: 'Waiting for another driver...' } as LocaleStrings,
    selectDriver: { he: 'בחר נהג זה', en: 'Select this driver' } as LocaleStrings,
    memberSince: { he: 'חבר מאז', en: 'Member since' } as LocaleStrings,
  },
  ...
  driver: {
    ...
    myJobs: { he: 'המשלוחים שלי', en: 'My deliveries' } as LocaleStrings,
    noActiveJobs: { he: 'אין משלוחים פעילים', en: 'No active deliveries' } as LocaleStrings,
    searchFeedHint: { he: 'חפש משלוחים זמינים בפיד', en: 'Search available deliveries in feed' } as LocaleStrings,
    noCompletedJobs: { he: 'אין משלוחים שהושלמו', en: 'No completed deliveries' } as LocaleStrings,
    completedJobsHint: { he: 'משלוחים שהושלמו יופיעו כאן', en: 'Completed deliveries will appear here' } as LocaleStrings,
    ...
    cancelConfirm: { he: 'האם אתה בטוח שברצונך לבטל את האיסוף?', en: 'Are you sure you want to cancel the pickup?' } as LocaleStrings,
    // Earnings / settings labels
    earnings: { he: 'הכנסות', en: 'Earnings' } as LocaleStrings,
    average: { he: 'ממוצע', en: 'Average' } as LocaleStrings,
    recentTransactions: { he: 'עסקאות אחרונות', en: 'Recent transactions' } as LocaleStrings,
    advancedSettings: { he: 'הגדרות מתקדמות', en: 'Advanced settings' } as LocaleStrings,
    quietHours: { he: 'שעות שקט', en: 'Quiet hours' } as LocaleStrings,
    quietHoursHint: { he: 'התראות יגיעו בשקט בשעות אלו', en: 'Notifications will be silenced during these hours' } as LocaleStrings,
    addQuietHours: { he: 'הוסף שעות שקט', en: 'Add quiet hours' } as LocaleStrings,
    favoriteAddresses: { he: 'כתובות מועדפות', en: 'Favorite addresses' } as LocaleStrings,
    saved: { he: 'נשמר', en: 'Saved' } as LocaleStrings,
    save: { he: 'שמור', en: 'Save' } as LocaleStrings,
    myLocation: { he: 'המיקום שלי', en: 'My location' } as LocaleStrings,
    nearHome: { he: 'ליד הבית', en: 'Near home' } as LocaleStrings,
    nearWork: { he: 'ליד העבודה', en: 'Near work' } as LocaleStrings,
    kmAway: { he: 'ק״מ', en: 'km' } as LocaleStrings,
    kmFromHome: { he: 'ק״מ מהבית', en: 'km from home' } as LocaleStrings,
    kmFromWork: { he: 'ק״מ מהעבודה', en: 'km from work' } as LocaleStrings,
    vehicleBicycle: { he: 'אופניים', en: 'Bicycle' } as LocaleStrings,
    vehicleBike: { he: 'קטנוע', en: 'Scooter' } as LocaleStrings,
    vehicleCar: { he: 'רכב', en: 'Car' } as LocaleStrings,
    vehicleTruck: { he: 'משאית', en: 'Truck' } as LocaleStrings,
    // DriverApprovalCard
    interestedInDelivery: { he: 'נהג מעוניין במשלוח', en: 'Driver interested in delivery' } as LocaleStrings,
    confirmDriver: { he: 'אשר נהג', en: 'Confirm driver' } as LocaleStrings,
    declineDriver: { he: 'דחה', en: 'Decline' } as LocaleStrings,
    driverLabel: { he: 'נהג', en: 'Driver' } as LocaleStrings,
    // DriverConfirmBanner
    selectionExpired: { he: 'פג תוקף הבחירה', en: 'Selection expired' } as LocaleStrings,
    senderSelectedYou: { he: 'השולח בחר בך!', en: 'The sender selected you!' } as LocaleStrings,
    confirmWithin: { he: 'אשר את המשלוח תוך', en: 'Confirm delivery within' } as LocaleStrings,
    confirm: { he: 'אשר', en: 'Confirm' } as LocaleStrings,
    decline: { he: 'דחה', en: 'Decline' } as LocaleStrings,
    // InterestedDriversList
    interestedDrivers: { he: 'נהגים מעוניינים', en: 'Interested drivers' } as LocaleStrings,
    awaitingDriverConfirmation: { he: 'ממתין לאישור הנהג', en: 'Awaiting driver confirmation' } as LocaleStrings,
    deliveriesCount: { he: 'משלוחים', en: 'deliveries' } as LocaleStrings,
    declined: { he: 'דחה', en: 'Declined' } as LocaleStrings,
    cancelledStatus: { he: 'בוטל', en: 'Cancelled' } as LocaleStrings,
    select: { he: 'בחר', en: 'Select' } as LocaleStrings,
    selected: { he: 'נבחר ✓', en: 'Selected ✓' } as LocaleStrings,
    cancelSelection: { he: 'בטל בחירה', en: 'Cancel selection' } as LocaleStrings,
  },
  ...
  map: {
    ...
    addressNotFound: { he: 'לא ניתן לאתר את הכתובת. נסה לבחור מהרשימה או הקש על המפה.', en: 'Could not find the address. Try selecting from the list or tap on the map.' } as LocaleStrings,
    mapsError: { he: 'בעיה בחיבור לשרת המפות. נסה שוב.', en: 'Problem connecting to maps service. Try again.' } as LocaleStrings,
    selectAddress: { he: 'יש לבחור כתובת', en: 'Select address' } as LocaleStrings,
    selectAddressHint: { he: 'בחר כתובת מהרשימה שמופיעה, או הקש על המפה כדי לסמן את המיקום.', en: 'Select an address from the list, or tap on the map to mark the location.' } as LocaleStrings,
  },
  ...
  permissions: {
    ...
    backgroundLocationDisclosureTitle: { he: 'שימוש במיקום ברקע', en: 'Background Location Use' } as LocaleStrings,
    backgroundLocationDisclosureBody: {
      he: 'MOOVIZ אוסף נתוני מיקום גם כאשר האפליקציה פועלת ברקע או סגורה.\n\nלמה? כדי לאפשר מעקב משלוחים בזמן אמת ולהציג את מיקומך לשולח בזמן הגעה ואיסוף.\n\nהמידע משמש אך ורק למטרות המשלוח ולא יועבר לצדדים שלישיים.',
      en: 'MOOVIZ collects location data even when the app is in the background or closed.\n\nWhy? To enable real-time delivery tracking and show your location to the sender during pickup and delivery.\n\nThis data is used solely for delivery purposes and is never shared with third parties.',
    } as LocaleStrings,
    backgroundLocationDisclosureAccept: { he: 'הבנתי, המשך', en: 'I understand, continue' } as LocaleStrings,
    backgroundLocationDisclosureDecline: { he: 'לא עכשיו', en: 'Not now' } as LocaleStrings,
  ...
  // ── Sender ──
  sender: {
    driversWaiting: { he: 'נהגים מחכים לתשובה', en: 'Drivers waiting for response' } as LocaleStrings,
    paymentsWaiting: { he: 'ממתינים לתשלום', en: 'Awaiting payment' } as LocaleStrings,
  },

  // ── Date ──
  date: {
    morning: { he: 'בוקר', en: 'Morning' } as LocaleStrings,
    afternoon: { he: 'צהריים', en: 'Afternoon' } as LocaleStrings,
    evening: { he: 'ערב', en: 'Evening' } as LocaleStrings,
    night: { he: 'לילה', en: 'Night' } as LocaleStrings,
  },
